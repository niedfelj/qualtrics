...
RSpec.describe Qualtrics::API::DistributionResource do
  ...
  describe '#all' do
    it 'returns all of the user records' do
      ...
      expected_records = Qualtrics::API::DistributionMapping.extract_collection(normalized_response, :read)
  ...
  describe '#find' do
    it 'returns a distribution' do
      ...
      expected_record = Qualtrics::API::DistributionMapping.extract_single(response, :read)
  ...
  describe '#create' do
    it 'returns created distribution with id' do
      ...
      expect(resource.create(Qualtrics::API::Distribution.new).id).to eq '123'
    end
  end
  ...
  describe '#create_thankyou' do
    it 'returns created thank you distributions with id' do
      ...
      expect(resource.create_thankyou(Qualtrics::API::Distribution.new, id: '789').id).to eq '123'
    end
  end
  ...
  describe '#create_reminder' do
    it 'returns created reminder distribution with id' do
      ...
      expect(resource.create_reminder(Qualtrics::API::Distribution.new, id: '789').id).to eq '123'
    end
  end
end
