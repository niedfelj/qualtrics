...
RSpec.describe Qualtrics::GroupResource do
  ...
  describe '#all' do
    it 'returns all the of group records' do
      ...
      expected_records = Qualtrics::GroupMapping.extract_collection(normalized_response, :read)
  ...
  describe '#find' do
    it 'returns a group' do
      ...
      expected_record = Qualtrics::GroupMapping.extract_single(response, :read)
  ...
  describe '#create' do
    it 'returns created group with id' do
      ...
      expect(resource.create(Qualtrics::Group.new).id).to eq '123'
    end
  end
  ...
  describe '#update' do
    it 'sends the update request for the group' do
      ...
      resource.update(Qualtrics::Group.new, id: '123')
